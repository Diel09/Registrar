...
const getRequest = async () => {
  try {
    const response = await axios.get('/get-RequestDetails'); // Replace with your actual endpoint
...
const approveConfirmation = (confirmed) => {
    ...
    if (confirmed) {
        axios.post(`/updateStatus`, {id: dtls.value.id})
        .then(() => {
...
const rejectConfirmation = (confirmed) => {
    showReject.value = false;

    if (confirmed) {
        axios.post(`/rejectStatus`, { id: dtls.value.id })
            .then(() => {
                showModal.value = false;
                ...
                <div class="relative w-full max-w-6xl max-h-full">
                    ...
                    <div class="p-6 relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex justify-end">   
                            <label type="button" @click="rejectStatus()" class="mt-3 text-white bg-red-800 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-900 dark:hover:bg-red-800 dark:focus:ring-red-900 dark:border-gray-700">
                                Disapprove
                            </label>
                            <div v-if="showReject" class="backdrop-blur-sm flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative w-fit max-w-6xl max-h-full">
                                    <div class="p-6 relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <div class="flex items-center justify-center p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                            ...
                                            <button @click="showReject = false" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
                                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                                </svg>
                                                <span class="sr-only">Close modal</span>
                                        ...
                                        <div class="w-96">
                                            ...
                                            <div class="flex justify-end">
                                                <button @click="rejectConfirmation(true)" class="mt-3 text-white bg-red-800 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-900 dark:hover:bg-red-800 dark:focus:ring-red-900 dark:border-gray-700">YES</button>
                                                <button @click="rejectConfirmation(false)" class="mt-3 text-white bg-green-800 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-600 dark:focus:ring-blue-500 dark:border-gray-700">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <label type="button" @click="updateStatus()" class="mt-3 text-white bg-green-800 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-600 dark:focus:ring-blue-500 dark:border-gray-700">Approve</label>                                     
                                ...
                                <div class="relative w-fit max-w-6xl max-h-full">
                                    ...
                                    <div class="p-6 relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="w-96">
                                            ...
                                            <div class="flex justify-end">
                                                <button @click="approveConfirmation(true)" class="mt-3 text-white bg-red-800 hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-900 dark:hover:bg-red-800 dark:focus:ring-red-900 dark:border-gray-700">YES</button>
