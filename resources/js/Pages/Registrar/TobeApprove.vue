...
const updateStatus = () => {
    if (confirm(`Are you sure to submit?`)) {
        axios.post(`/updateStatus`, {id: dtls.value.id}).then(() => {
            alert(`submited!`);
            getRequest();
...
const rejectStatus = () => {
    if (confirm(`Are you sure to reject?`)) {
        axios.post(`/rejectStatus`, {id: dtls.value.id}).then(() => {
            alert(`rejected!`);
            getRequest();
            showModal.value = false;
         })
                        ...
                        <div class="relative w-full max-w-6xl max-h-full">
                            ...
                            <div class="p-6 relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="flex justify-end">
                                    <button type="button" @click="rejectStatus()" class="mt-3 text-white bg-red-800 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-600 dark:focus:ring-blue-500 dark:border-gray-700">Disapprove</button>         
                                    <button type="button" @click="updateStatus()" class="mt-3 text-white bg-green-800 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-800 dark:hover:bg-blue-600 dark:focus:ring-blue-500 dark:border-gray-700">Approve</button>                                     
                                </div>
                            </div>
                        </div>
                    </div>
